...
IngredientDetails.propTypes = {
	...
	proteins: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
	fat: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
	carbohydrates: PropTypes.oneOfType([PropTypes.string, PropTypes.number]).isRequired,
};
